var store = [{
        ...
        "excerpt":"Porti Seguro’s Safe Driver Prediction Data Description Porti Segure’s Sage Driver Prediction 유사한 그룹에 속하는 특징들은 특징 이름에 해당하는 태그로 표시됩니다 (예 : ind, reg, car, calc). 이진 특징은 postfix “bin”으로 표시되며 범주형 특징은 “cat”으로 표시됩니다. 이러한 표기가 없는 특징은 연속형 또는 서수형입니다. 값 -1은 관찰에서 특징이 누락되었음을 나타냅니다. 타겟...","categories": ["kaggle"],
        "tags": ["kaggle"],
        ...
        "excerpt":"TIPS Visualization 데이터 준비 Seaborn의 load_dataset() 메소드를 통해 유명 예제 데이터를 다운로드 받을 수 있다. 연습용 데이터 repo 여러 데이터들 중에서 종업원들의 tip을 정리한 데이터 셋인 tips를 통해 시각화를 해보자. import pandas as pd import seaborn as sns import numpy as np import warnings warnings.filterwarnings('ignore') tips = sns.load_dataset(\"tips\") EDA df...","categories": ["vs"],
        "tags": ["matplotlib","seaborn"],
        "url": "http://localhost:4000/vs/tips/",
        "teaser": null
      },{
