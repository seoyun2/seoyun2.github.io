...
* 손실함수가 Hinge Loss 모양이라는 것을 생각해 보면 $\infin$, 0 <br>
...
<img width="869" alt="L3_06" src="https://user-images.githubusercontent.com/86525868/171037052-7a41fb79-06f0-436f-9e0b-6e1da3a269d8.png">{: width="30%" height="30%"}{: .align-center}
...
* Loss가 0이 되려면 실제 스코어는 무한대에 가깝게 높아야하고 지수화와 정규화를 하기 때문에 확률 1(정답), 0(그외)를 얻으려면 정답 클래스의 스코어는 $+\infin$, 나머지는 $-\infin$이 되어야 함
* 최댓값은 없음 <br>
